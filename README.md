...
N - Make Noise (distracts nearby hunters)

B - Bang Tree (scares nearby hunters and can create bridges)
...
Bridges (🪵) - Created by banging trees next to rivers

Mushrooms (🍄) - Collect to gain invisibility power

Ponds (🏞️) - Block movement for both you and hunters
...
Multiple Terrains: Rivers, ponds, trees, and bridges add strategic depth

Power-ups: Mushrooms grant temporary invisibility

Start Screens: Beautiful overlay screens for game states
...
Movement: Grid-based with cooldown system

Game Loop: Automated hunter movement every 800ms
...
Level 3+: Rivers appear (need bridges to cross)

Level 6+: Mushrooms appear (grant invisibility)
...
Create Distractions: Use noise to lure hunters away from your path

Bridge Building: Remember to create bridges before crossing rivers

Save Mushrooms: Use invisibility at critical moments
